// const year = document.querySelector(".output-year");
// const month = document.querySelector(".output-month");
// const day = document.querySelector(".output-day");
